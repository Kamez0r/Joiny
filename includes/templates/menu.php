...
<?php $this_page = (pathinfo($_SERVER['SCRIPT_NAME'])['filename']); ?>


<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">Joiny Webview</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#sidebarMenu" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 <?php echo $this_page == 'home' ? 'active' : ''; ?>" href="<?php echo base_url();?>home.php">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 <?php echo $this_page == 'ingest' ? 'active' : ''; ?>" href="<?php echo base_url();?>ingest.php">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 <?php echo $this_page == 'transactions' ? 'active' : ''; ?>" href="<?php echo base_url();?>transactions.php">
            ...
            <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-body-secondary text-uppercase">
                ...
                <a class="link-secondary" href="#" aria-label="Click Me?">#</a>
            </h6>
